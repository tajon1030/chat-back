...
public class ChatController {
    ...
    public ApiResult<?> getChatMessages(@PathVariable String roomId, @AuthenticationPrincipal UserDetailsImpl user) {
        // 내가 참여한 채팅방인지 검증
        ...
        return ApiResult.OK(chatService.getChatMessages(roomId));
    }
